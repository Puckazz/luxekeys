        ...
        <form className="space-y-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <label className="text-muted-foreground cursor-pointer text-sm">
              I agree to the <span className='text-primary hover:text-primary/80 text-sm transition-colors'>Term of Service</span> and <span className='text-primary hover:text-primary/80 text-sm transition-colors'>Privacy Policy</span>
            </label>
          </div>
